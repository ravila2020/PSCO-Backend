...
import mx.com.oneproject.spco.respuesta.AnsSysAduPartCP;
...
//        	 															System.out.print("\n " + "          + RestSysAduPartController Apendice: " + i + " - " + todosSysAduPart.get(i).getClveProduc() + " - " + todosSysAduPart.get(i).getTipProd() + " - " + todosSysAduPart.get(i).getDescCorIng());
	 ...
	 * @see 
	 */	
    @GetMapping(path = {"/PartCliente"})
    public AnsSysAduPartCP listarParteCliente(@RequestParam(required = false, value = "cliente") String cliente,
    ...
    // Validación de token
    	...
    	int page = 1;
    	int perPage = 9999;
    	AnsSysAduPartCP respuesta = new AnsSysAduPartCP();
	...
	// Preparación de la paginación.
		...
		llaveAnterior.setNumPart("0000000000");		
    // obtener el total de sys_usuarios -----------------------------------------------------------------
         todos = aduPart.countByTodoERCP(empresaS,recintoS,cliente,parte);
       	 System.out.print("\n\n + RestSysAduPartController listarPag empresaS: " + empresaS + " recintoS: " + recintoS + " cliente: " + cliente + " parte: " + parte + " todos: " + todos+"\n ");
         paginas = (double) todos / perPage;
         pagEntero = (int) paginas;
         if ((paginas-pagEntero)>0)
         {
    ...
    // Obtener la lista de sys_usuarios solicitada 
         SysAduPartInicial = (perPage  * (page - 1) );
         SysAduPartFinal   = (SysAduPartInicial + perPage) - 1;
         todosSysAduPart  = aduPart.BuscarByTodoERCP(empresaS,recintoS,cliente,parte);
         paginaSysAduParts = aduPart.BuscarByTodoERCP(empresaS,recintoS,cliente,parte);
...
//        	 															System.out.print("\n " + "          + RestSysAduPartController Apendice: " + i + " - " + todosSysAduPart.get(i).getClveProduc() + " - " + todosSysAduPart.get(i).getTipProd() + " - " + todosSysAduPart.get(i).getDescCorIng());
 ...
 //       		 }
		 ...
		 respuesta.setCr("00");
		 respuesta.setDescripcion("Correcto");
		 respuesta.setContenido(paginaSysAduParts);
		 return respuesta;
    }
